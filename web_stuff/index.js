...
var ASM_CONSTS = {
  144621: () => { if (document.fullscreenElement) return 1; },  
 144667: () => { return Module.canvas.width; },  
 144699: () => { return parseInt(Module.canvas.style.width); },  
 144747: () => { document.exitFullscreen(); },  
 144774: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 144846: () => { if (document.fullscreenElement) return 1; },  
 144892: () => { return Module.canvas.width; },  
 144924: () => { return screen.width; },  
 144949: () => { document.exitFullscreen(); },  
 144976: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 145109: () => { return window.innerWidth; },  
 145135: () => { return window.innerHeight; },  
 145162: () => { if (document.fullscreenElement) return 1; },  
 145208: () => { return Module.canvas.width; },  
 145240: () => { return parseInt(Module.canvas.style.width); },  
 145288: () => { if (document.fullscreenElement) return 1; },  
 145334: () => { return Module.canvas.width; },  
 145366: () => { return screen.width; },  
 145391: () => { return window.innerWidth; },  
 145417: () => { return window.innerHeight; },  
 145444: () => { if (document.fullscreenElement) return 1; },  
 145490: () => { return Module.canvas.width; },  
 145522: () => { return screen.width; },  
 145547: () => { document.exitFullscreen(); },  
 145574: () => { if (document.fullscreenElement) return 1; },  
 145620: () => { return Module.canvas.width; },  
 145652: () => { return parseInt(Module.canvas.style.width); },  
 145700: () => { document.exitFullscreen(); },  
 145727: ($0) => { Module.canvas.style.opacity = $0; },  
 145765: () => { return screen.width; },  
 145790: () => { return screen.height; },  
 145816: () => { return window.screenX; },  
 145843: () => { return window.screenY; },  
 145870: () => { return window.devicePixelRatio; },  
 145906: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 145959: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 146010: () => { Module.canvas.style.cursor = 'none'; },  
 146047: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 146303: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 146354: () => { if (document.pointerLockElement) return 1; },  
 146401: () => { if (document.fullscreenElement) return 1; },  
 146447: () => { return window.innerWidth; },  
 146473: () => { return window.innerHeight; }
};
